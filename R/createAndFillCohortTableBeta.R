...
#'
#' @examples
createAndFillCohortTableBeta<-function(connection,
  ...
  cohortTableNames <- CohortGenerator::getCohortTableNames(cohortTable = cohortName)
  CohortGenerator::createCohortTables(connectionDetails = connectionDetails,
                                      cohortDatabaseSchema = trajectoryLocalArgs$cdmDatabaseSchema,
                                      cohortTableNames = cohortTableNames)

  # Generate the cohorts
  cohortsGenerated <- CohortGenerator::generateCohortSet(connectionDetails = connectionDetails,
                                                         cdmDatabaseSchema = trajectoryLocalArgs$cdmDatabaseSchema,
                                                         tempEmulationSchema = trajectoryLocalArgs$resultsSchema,
                                                         cohortDatabaseSchema = trajectoryLocalArgs$cdmDatabaseSchema,
