...
dbCleanup<-function(connection,
  ...
  ParallelLogger::logInfo("Cleanup: dropping all analysis tables with prefix '",trajectoryLocalArgs$prefixForResultTableNames,"' from database...")

  #Set SQL role of the database session
  Trajectories:::setRole(connection,trajectoryLocalArgs$sqlRole)

  RenderedSql <- Trajectories:::loadRenderTranslateSql("12TableDropper.sql",
