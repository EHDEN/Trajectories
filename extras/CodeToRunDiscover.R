...
trajectoryLocalArgs <- Trajectories::createTrajectoryLocalArgs(oracleTempSchema = "temp_schema",
                                                               ...
                                                               databaseHumanReadableName='DBNAME') #Use something short. This will be used as a folder name an it will be added to the titles of the graph.
...
Trajectories::discover(connection,
                       ...
                       forceRecalculationOfAnalysis=T, #used only if runDiscoveryAnalysis=T
