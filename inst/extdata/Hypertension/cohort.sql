...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (42709887,316866,4167493,4322024)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (42709887,316866,4167493,4322024)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4305577,321588,4322024,4167493,316866,42709887)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4305577,321588,4322024,4167493,316866,42709887)
  and c.invalid_reason is null
