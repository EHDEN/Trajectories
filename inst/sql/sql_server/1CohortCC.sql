...
--CREATE TABLE @resultsSchema.@prefiXE1E2_model as
    SELECT
            E1_CONCEPT_ID,
            E2_CONCEPT_ID,
            round(avg(diff_days),0) avg_number_of_days_between_events,
            count(*) E1_E2_EVENTPERIOD_COUNT
...
ALTER TABLE @resultsSchema.@prefiXE1E2_model ADD E1_NAME VARCHAR(255) NULL;
ALTER TABLE @resultsSchema.@prefiXE1E2_model ADD E1_DOMAIN VARCHAR(20) NULL;
...
--- Instead of using concept id-s, take concept names + concept domains to E1E2_model from concept table
UPDATE @resultsSchema.@prefiXE1E2_model
